...
$customBaseControllerClass = StringHelper::basename($generator->customBaseControllerClass);
...
namespace <?= StringHelper::dirname(ltrim($generator->customBaseControllerClass, '\\')) ?>;
